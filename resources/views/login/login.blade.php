                            ...
                            <div class="card-body">
                                ...
                                <form action="{{url('/user-login')}}" method="GET">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" name="txtUsername" value="admin@admin.net" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                    </div>
                                    <div class="mb-4">
                                        <label for="exampleInputPassword1" class="form-label">Password</label>
                                        <input type="password" name="txtPassword" value="123456789" class="form-control" id="exampleInputPassword1">
                                    </div>
